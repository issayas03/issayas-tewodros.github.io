...
_.first = function (array, number) {
   ...
   //if number is not given return first element in array
   if (number === undefined || typeof number !== 'number' || number === NaN || number === null) {
       return array[0]
   }
   //return entire array if number is greater than number of values in array
...
_.last = function (array, number) {
    ...
    if (number === undefined || number === null || typeof number !== 'number' || number === NaN) {
        return array[array.length - 1]
    }
    //If number is greater than length of the array return array
    if (number > array.length) {
        return array
    }
    //Return an array displaying the last <number> elements of the argument array
    for (let i = 0; i <= number; i++) {
        output.push(array[i])
    }
